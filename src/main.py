...
def print_morning_brief(events_count: int, analytics: AnalyticsEngine) -> None:
    """
    ...
    print("Respond to Example Staffing.")
    print()
    print("Reason")
    print("High resume match.")
    print("Previously successful recruiter.")
...
def main() -> None:
    ...
    print_morning_brief(len(events), analytics)
